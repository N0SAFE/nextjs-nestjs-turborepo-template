...
5. **Documentation Maintenance (Core Concept 10)**:
   - If feature affects project structure: Ask about documentation updates
   - Parent README should be kept in sync

**Strategy**: When clarification reveals multiple valid approaches, present the core concept-aligned option as the recommended approach with rationale.
