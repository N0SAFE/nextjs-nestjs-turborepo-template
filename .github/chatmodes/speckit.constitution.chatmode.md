...
3a. **Core Concepts Compliance Section** (MANDATORY):
   ...
   **Required Content**:
   ...
   - For each concept, document: Status, Enforcement, Validation
   - Add compliance requirement statement referencing `/speckit.validate-core-concepts`
   - Document conflicts with core concepts if applicable
