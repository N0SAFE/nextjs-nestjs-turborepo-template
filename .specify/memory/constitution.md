...
- ✅ All test configurations inherit from `@repo/config-vitest`
...
All tests MUST use Vitest with configurations inherited from `@repo/config-vitest`. Test files
...
- ✅ Test config per-package inherits from `@repo/config-vitest`
