 ...
 */
export class ResourceBuilder<TStatement extends Record<string, readonly string[]>, TResource extends string, TRoles extends Record<string, any> = object> {
    constructor(private builder: PermissionBuilder<TStatement, TRoles>, private resourceName: TResource) {}
     ...
     */
    actions<TActions extends readonly string[]>(actions: TActions): PermissionBuilder<TStatement & Record<TResource, TActions>, TRoles> {
        this.builder._statement[this.resourceName] = actions;
        return this.builder as unknown as PermissionBuilder<TStatement & Record<TResource, TActions>, TRoles>;
    }
}
 ...
 */
export class RoleBuilder<TStatement extends Record<string, readonly string[]>, TRoles extends Record<string, any>, TRoleName extends string = string> {
    constructor(private builder: PermissionBuilder<TStatement, TRoles>, private roleName: TRoleName, private ac: ReturnType<typeof createAccessControl<TStatement>>) {}
    ...
    >(permissions: TPermissions): PermissionBuilder<TStatement, TRoles & Record<typeof this.roleName, TPermissions>> {
        // @ts-expect-error - Type manipulation for builder pattern
        this.builder._roles[this.roleName] = this.ac.newRole(permissions);
        return this.builder as PermissionBuilder<TStatement, TRoles & Record<typeof this.roleName, TPermissions>>;
    }
    ...
    allPermissions(): PermissionBuilder<TStatement, TRoles & Record<typeof this.roleName, TStatement>> {
        ...
        return this.builder as PermissionBuilder<TStatement, TRoles & Record<typeof this.roleName, TStatement>>;
    }
}
 ...
 */
export class PermissionBuilder<TStatement extends Record<string, readonly string[]> = Record<string, readonly string[]>, TRoles extends Record<string, any> = object> {
    /** @internal */
    ...
    private _ac?: ReturnType<typeof createAccessControl<any>>;
    private _statementsConfig?: StatementsConfig<TStatement>;
    private _rolesConfig?: RolesConfig<TRoles>;

    constructor(defaultStatement: TStatement) {
        this._statement = defaultStatement;
    }
     ...
     */
    static withDefaults<TDefaults extends Record<string, readonly string[]>>(defaultStatements: TDefaults): PermissionBuilder<TDefaults> {
        return new PermissionBuilder({ ...defaultStatements });
    }
     ...
     */
    resource<TResource extends string>(name: TResource): ResourceBuilder<TStatement, TResource, TRoles> {
     ...
     */
    resources<TResources extends Record<string, readonly string[]>>(resources: TResources): PermissionBuilder<TStatement & TResources, TRoles> {
     ...
     */
    role<TRole extends string>(name: TRole): RoleBuilder<TStatement, TRoles, TRole> {
     ...
     * @returns The PermissionBuilder for method chaining
     */
    roles<TNewRoles extends Record<string, any>>(rolesFactory: (ac: ReturnType<typeof createAccessControl<TStatement>>) => TNewRoles): PermissionBuilder<TStatement, TRoles & TNewRoles> {
        this._ac ??= createAccessControl(this._statement);
    ...
    build() {
        ...
        return {
            ...
            ac: this._ac as ReturnType<typeof createAccessControl<TStatement>>,
 ...
 */
export function createPermissionBuilderWithDefaults<TDefaults extends Record<string, readonly string[]>>(defaultStatements: TDefaults) {
