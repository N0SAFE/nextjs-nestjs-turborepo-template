...
describe("Auth Decorators", () => {
  ...
  describe("Decorator Application", () => {
    ...
    it("should apply OptionalAuth decorator to method", () => {
      ...
      expect(TestController).toBeDefined();
      expect(
        TestController.prototype.testMethod.bind(TestController.prototype),
      ).toBeDefined();
    });
    ...
    it("should apply multiple decorators", () => {
      ...
      expect(TestHookProvider).toBeDefined();
      expect(
        TestHookProvider.prototype.beforeTest.bind(TestHookProvider.prototype),
      ).toBeDefined();
      expect(
        TestHookProvider.prototype.afterTest.bind(TestHookProvider.prototype),
      ).toBeDefined();
    });
  });
  ...
  describe("Decorator Combination", () => {
    it("should allow combining multiple decorators", () => {
      ...
      expect(
        TestController.prototype.complexMethod.bind(TestController.prototype),
      ).toBeDefined();
    });
