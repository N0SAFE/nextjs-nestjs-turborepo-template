...
import {
  assertAuthenticated,
  type ORPCAuthContext,
  type ORPCAuthenticatedContext,
} from "./types";
...
describe("ORPC Auth Types", () => {
  ...
  describe("assertAuthenticated", () => {
    ...
    it("should narrow type to ORPCAuthenticatedContext", () => {
      const result: ORPCAuthenticatedContext = assertAuthenticated(
        mockAuthenticatedContext,
      );
    ...
    it("should throw error when user is not logged in", () => {
      expect(() => assertAuthenticated(mockUnauthenticatedContext)).toThrow(
        "Auth context is not authenticated",
      );
    });
    ...
    it("should throw error when session is null", () => {
      ...
      expect(() => assertAuthenticated(partialContext)).toThrow(
        "Auth context is not authenticated",
      );
    });
