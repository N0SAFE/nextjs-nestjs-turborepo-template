...
describe("UserRepository", () => {
    ...
    describe("findMany", () => {
        it("should find users with pagination", async () => {
            ...
            mockDb.select.mockReturnValueOnce(mainQueryBuilder).mockReturnValueOnce(countQueryBuilder);
        ...
        it("should throw error for unsupported sort field", async () => {
            ...
            await expect(repository.findMany(input)).rejects.toThrow("Unsupported sort field: unsupported");
        });
    });
    ...
    describe("transformUsers", () => {
        it("should transform array of users", () => {
            ...
            expect(result).toEqual([transformedUser, { ...transformedUser, id: "2" }]);
        });
