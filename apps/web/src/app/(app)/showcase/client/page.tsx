...
import { Showcase, ShowcaseServer } from '@/routes'
import { ArrowLeft, Monitor, Zap, RefreshCw, Database } from 'lucide-react'
import ClientSideShowcase from './ClientSide'

const ShowcaseClientPage: React.FC = function ShowcaseClientPage() {
    return (
        <div className="container mx-auto space-y-8 px-4 py-8">
            {/* Back Navigation */}
            <Showcase.Link className="text-muted-foreground hover:text-foreground inline-flex items-center space-x-2 text-sm">
